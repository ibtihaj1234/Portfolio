            ...
            <div className='briefing'>
                ...
                <div className='Education'>
                    ...
                    <div className='content'>
                        <div className='image'>
                            <img className='img' src={require('../../assets/Hamdard.jpeg')} alt='img' />
                        </div>
                        <div className='Contenttxt'>
                            <p style={{ fontSize: 'X-Large', color: 'black' }} >An undergraduate student of Bachelors Science in Computer Science at Hamdard University Karachi. Undergratuating since 2021 Currently i am a 3rd year student 5th semester student</p>
                        </div>
                    </div>
                </div>
            </div>
